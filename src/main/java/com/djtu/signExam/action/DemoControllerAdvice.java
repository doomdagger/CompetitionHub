package com.djtu.signExam.action;
 ...
 * 
 * 举例来说，包：com.djtu.signExam.action.repository 负责存放所有跟仓库管理功能相关的Controller，
 * 那么对应的,在com.djtu.signExam.action.advice中，就应该有RepositoryControllerAdvice类，来为这个包下
 * 的全部Controller提供统一的配置信息：包括DataBinder, ModelAttribute等等。
 * 
 * @author Li He
 * 
 */
@ControllerAdvice(basePackages="com.djtu.signExam.action.demo")
