package com.djtu.signExam.config;
...
public class ProjectConfig {
	...
	private static String default_config = "/com/djtu/signExam/config/project.properties";
    ...
    static {
        ...
        try {
            ...
            Class configClass = Class.forName("com.djtu.signExam.config.ProjectConfig");
            ...
            if (is != null) {
                ...
                if (is != null) {
                    config.load(is);
                    System.out.println("Project Config: Successfully loaded custom properties file from classpath");
                    System.out.println("File path : " + configClass.getResource(custom_config).getFile());
                } else {
                    System.out.println("Project Config: No custom properties file found in classpath");
                }
