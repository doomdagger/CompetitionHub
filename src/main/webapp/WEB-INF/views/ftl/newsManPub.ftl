        ...
        <div class="alert alert-info">
            <form role="form" id="newsPubForm" method="get" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" id="title" placeholder="请输入新闻标题" value="<#if news??>${news.title?if_exists}</#if>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="editor_id" placeholder="新闻内容"><#if new??>${news.content?if_exists}</#if></textarea>
                </div>
