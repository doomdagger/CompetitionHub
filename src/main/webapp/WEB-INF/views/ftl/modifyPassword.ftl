                    ...
                    <form role="form">
                        <div  id="divGetCheckCode"><#--验证模块-->
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-success btn-xs" id="btnSendEmail">点击发送验证码至你的邮箱<#if user?exists>：${user.email?if_exists}</#if></button>
                        ...
                        <div id="divSetPwd" style="display: none"><#--修改模块-->
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="newPwd" placeholder="输入要设置的新密码">
                            </div>
                            <div class="form-group">
