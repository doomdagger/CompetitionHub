...
<head>
    ...
    <!--<link rel="stylesheet" href="/resources/flat/css/flat-ui.css">-->
    ...
    <!--common bottom part end-->
</head>


<#--body-->
<body  style="background-image:url(/resources/img/img-bg4.png);background-attachment:fixed;">
...
<div class="container-fluid">
    ...
    <div class="col-xs-12 navbar alert alert-info">
        <nav class="navbar" role="navigation">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left common-navbar" style="font-size: 18px;">
    ...
    <#--<nav class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="/index"><span class="glyphicon glyphicon-home">首页</span></a>
        </div>
